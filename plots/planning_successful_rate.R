...
# ggplot(data=budget_03, aes(x=Deadline, y=Success.Rate, fill=Algorithm)) + geom_bar(stat="identity", position=position_dodge()) + geom_text(aes(label=Success.Rate), vjust=1.6, color="white", position = position_dodge(0.9), size=3.5) + ggtitle("Planning Successful Rate Algorithm Comparison (Budget=0.3)") + ylab("Planning Successful Rate (%)") + theme(plot.title = element_text(hjust = 0.5))
# ggplot(data=budget_05, aes(x=Deadline, y=Success.Rate, fill=Algorithm)) + geom_bar(stat="identity", position=position_dodge()) + geom_text(aes(label=Success.Rate), vjust=1.6, color="white", position = position_dodge(0.9), size=3.5) + ggtitle("Planning Successful Rate Algorithm Comparison (Budget=0.5)") + ylab("Planning Successful Rate (%)") + theme(plot.title = element_text(hjust = 0.5))
ggplot(data=budget_07, aes(x=Deadline, y=Success.Rate, fill=Algorithm)) + geom_bar(stat="identity", position=position_dodge()) + geom_text(aes(label=Success.Rate), vjust=1.6, color="white", position = position_dodge(0.9), size=3.5) + ggtitle("Planning Successful Rate Algorithm Comparison (Budget=0.7)") + ylab("Planning Successful Rate (%)") + theme(plot.title = element_text(hjust = 0.5))
